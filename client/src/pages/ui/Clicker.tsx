export default function Clicker(props: {
  ...
  return (
    <svg
      ...
      // className={"bauble " + (props.selected && "selected")}
    >
    ...
    //   {/* <svg width={"100%"} height={"100%"} x={`${props.x}%`} y={`${props.y}%`}>
    //     <g transform="scale(1, 1)">
